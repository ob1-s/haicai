...
# Vocabulário compilado (ver tools/compila_vocabulario.py): veredito do
# LanguageTool sobre o corpus, congelado em arquivo para lookup O(1)
# fora do caminho quente de treino.
VOCABULARIO = Path(__file__).resolve().parents[2] / "data" / "vocabulario_ortografico.txt"
